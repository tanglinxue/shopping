...
let pixelRatio = device.pixelRatio;
  ...
  function cut() {
    ...
    */
    self.setBoundStyle = function () {
      ...
      self.ctx.moveTo(x - lineWidth, y + 20 - lineWidth);
      self.ctx.lineTo(x - lineWidth, y - lineWidth);
      self.ctx.lineTo(x + 20 - lineWidth, y - lineWidth);
      self.ctx.stroke
      ...
      self.ctx.setStrokeStyle(color);
      self.ctx.setLineWidth(lineWidth);
      self.ctx.moveTo(x - lineWidth, y + height - 20 + lineWidth);
      self.ctx.lineTo(x - lineWidth, y + height + lineWidth);
      self.ctx.lineTo(x + 20 - lineWidth, y + height + lineWidth);
      self.ctx.stroke
      ...
      self.ctx.setStrokeStyle(color);
      self.ctx.setLineWidth(lineWidth);
      self.ctx.moveTo(x + width - 20 + lineWidth, y - lineWidth);
      self.ctx.lineTo(x + width + lineWidth, y - lineWidth);
      self.ctx.lineTo(x + width + lineWidth, y + 20 - lineWidth);
      self.ctx.stroke
      ...
      self.ctx.setStrokeStyle(color);
      self.ctx.setLineWidth(lineWidth);
      self.ctx.moveTo(x + width + lineWidth, y + height - 20 + lineWidth);
      self.ctx.lineTo(x + width + lineWidth, y + height + lineWidth);
      self.ctx.lineTo(x + width - 20 + lineWidth, y + height + lineWidth);
      self.ctx.stroke();
    };
  }
